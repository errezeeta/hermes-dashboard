        ...
        <>
          ...
          <div className="fade-in" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "var(--s-4)", marginBottom: "var(--s-8)" }}>
            ...
            <div className="card">
              ...
              <div style={{ fontFamily: "'VT323', monospace", fontSize: "1.1rem", color: trendColor(data.steps.trend), lineHeight: 1.1 }}>
          ...
          <div className="card fade-in" style={{ marginBottom: "var(--s-8)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "var(--s-3)" }}>
              ...
              <span style={{ fontFamily: "'VT323', monospace", fontSize: "0.875rem", color: "var(--color-text-muted)" }}>
                {Math.round(stepPct)}%
              </span>
            </div>
...
function MetricBlock({ label, value }: { label: string; value: string }) {
  return (
    <div className="card">
      ...
      <div style={{ fontFamily: "'VT323', monospace", fontSize: "1.5rem", fontWeight: 700, color: "var(--color-text-primary)", lineHeight: 1.1 }}>
        {value}
      </div>
    </div>
  );
...
function Stat({ label, value, color }: { label: string; value: string; color?: string }) {
  return (
    <div>
      ...
      <div style={{ fontFamily: "'VT323', monospace", fontSize: "1rem", color: color ?? "var(--color-text-primary)" }}>
        {value}
      </div>
    </div>
  );
...
function Loading() {
  return (
    <div style={{ maxWidth: "960px", margin: "0 auto", padding: "var(--s-12) var(--s-6)", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "60vh" }}>
      <span style={{ fontFamily: "'VT323', monospace", fontSize: "0.875rem", color: "var(--color-text-muted)" }}>loading health data...</span>
    </div>
  );
}
